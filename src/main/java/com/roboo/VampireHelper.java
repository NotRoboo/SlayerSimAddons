...
public class VampireHelper {
    ...
    private static final double TARGET_Z         = -53.5;
    private static final double Z_TOLERANCE      = 0.1;

    private static final double TARGET_X         = -124.5;
    ...
    private static void handleMessage(String msg) {
        if (msg == null) return;
        if (!ModConfig.getPathfindingMode().equals("Vampire")) return;
    ...
    private static void onTick() {
        if (mc.player == null || !ModConfig.getPathfindingMode().equals("Vampire")) return;
